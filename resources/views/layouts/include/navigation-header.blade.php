...
?>
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style="min-width: 100vw; width: 100%; padding-left: 15px; padding-right: 15px;">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="{{ route('panel') }}" style="min-width: 250px; flex-shrink: 0; margin-right: 30px;">
        {{$empresa->nombre ?? ''}}
    </a>
    <!-- Sidebar Toggle-->
    <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
    <!-- Navbar Search-->
    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-4 my-2 my-md-0" style="min-width: 400px;">
        <div class="input-group">
            <input name="search" class="form-control" type="text" placeholder="Buscar ...." aria-label="Search for..." aria-describedby="btnNavbarSearch" style="width: 320px;" />
